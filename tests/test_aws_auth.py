...
class TestRoleConfig:
    ...
    def test_invalid_account_id(self):
        ...
        with pytest.raises(ValueError, match="account_id must be a 12-digit string"):
            RoleConfig(role_arn="arn:aws:iam::123456789012:role/TestRole", account_id="invalid")
...
class TestAWSAuthConfig:
    ...
    def test_from_env(self):
        ...
        assert config.roles["test"].role_arn == "arn:aws:iam::123456789012:role/TestRole"
    ...
    def test_single_role_env_config(self):
        ...
        assert config.roles["default"].role_arn == "arn:aws:iam::123456789012:role/DefaultRole"
...
class TestConvenienceFunctions:
    ...
    async def test_create_client_alias(self):
        ...
        with patch("agents.sre_agent.aws_auth.get_authenticated_client") as mock_get_client:
    ...
    async def test_test_auth_function(self):
        ...
        with patch("agents.sre_agent.aws_auth.get_auth_service") as mock_get_service:
            ...
            mock_service.test_credentials = AsyncMock(return_value={"status": "success"})
    ...
    def test_configure_auth_function(self):
        ...
        config = configure_auth(default_region="us-west-2", enable_caching=False, test_role=role)
